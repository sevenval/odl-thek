...
router.get('/',   function(req, res) { //helper.ensureAuthenticated,
...
// 					// bookings.find({ gadget : _result[i]._id.toString() }).sort({end:-1}).limit(1).toArray(function(_err,_last_booking_result){
